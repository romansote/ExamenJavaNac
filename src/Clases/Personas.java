...
public class Personas {
    ...
    public static final String USUARIO = "roman"; 
    public static final String PASSWORD = "roman123";
                ...
                if(getTxtApellidoM().getText().length()>0){
                  //  if(rbHombre.isSelected() || rbMujer.isSelected()){
                        if(getTxtPeso().getText().length()>0){
                          ...
                          //  }else{
                            //    JOptionPane.showMessageDialog(null, "Debe ingresar su Sexo para continuar...");
                                        ...
                                        if(getTxtTalla().getText().length()>0){
                                            if(getComboTipoParto().getSelectedIndex()>0){
                                               if(getRbFalleceSi().isSelected()){fallece = "si";}
                                                         ...
                                                         // if(verificarExistenciaRut(getTxtRut().getText()) == false){
                                                     //    String sql = "UPDATE Paciente set apellido_paterno='"+getTxtApellidoP().getText()+"',tipo_parto='"+getComboTipoParto().getSelectedItem()+"',peso = "+getTxtPeso().getText()+",talla="+getTxtTalla().getText()+",fallece='"+fallece+"' WHERE id_paciente = '"+rut+"'";
